...
public class Ahorcado extends JFrame {
    ...
    private final ArrayList<ArrayList<String>> arrayPalabras = new ArrayList<>(); //ArrayList que contiene los ArrayList contenedores de las palabras de las categorias
    ...
    private JPanel getPanelOpciones() {
        ...
        String categorias[] = new String[]{ //Contiene las 4 categorias que se eligen en el JComboBox
            "Paises latinoamericanos", "Sistemas operativos", "Frutas", "Instrumentos musicales"};
        ...
        JButton btnJugar = new JButton("Jugar"); //Se agrega la instancia btnJugar de tipo JButton, usando el constructor para asignar el texto "Jugar"
     ...
     *
     * @param idImagen Recibe la pocision que contiene la imagen que se va a
     * mostrar
     */
    ...
    /**
     * Crea y agrega tres paneles al panel estado. 
     * 1. contiene la etiqueta (perdiste/ganaste). 
     * 2. modifica la imagen del ahorcado segun el estado del juego 
     * 3. agrega las letras de la palabra que se esta adivinando
     *
